...
app = FastAPI(title=settings.title, version=settings.version, description=settings.title)
...
if __name__ == "__main__":
    log.error("Run me like: uvicorn app.main:app --host=0.0.0.0 --port=8000 --reload")
